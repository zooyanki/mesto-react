  ...
  return (
    <div className="App">
      ...
      <div className="content">
         ...
         <PopupWithForm isOpen={isAddPlacePopupOpen[0]} onClose={closeAllPopups} name="newform" title="Новое место">
              <>            
          ...
          <PopupWithForm isOpen={isEditProfilePopupOpen[0]} onClose={closeAllPopups} name="editor" title="Редактировать профиль">
                <label className="modal__label">
          ...
          <PopupWithForm isOpen={isEditAvatarPopupOpen[0]} onClose={closeAllPopups} name="updateavatar" title="Обновите аватар">             
                <label className="modal__label">
