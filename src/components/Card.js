...
function Card(props) {
    ...
    return (
        <div className="element">
            ...
            <button className="element__trash element__trash_invisible" aria-label="remove" type="button"></button>
            <div className="element__name">
                <p className="element__text">{props.image.name}</p>
                <div className="element__group-container">
                    <button className="element__group" type="button" aria-label="like"></button>
